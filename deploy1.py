...
def plot_boxes(results, frame,classes):
    ...
    for i in range(n):
        ...
        if row[4] >= 0.55: ### threshold value for detection. We are discarding everything below this value
            ...
            cv2.rectangle(frame, (x1, y1-20), (x2, y1), (255, 0,0), -1) ## for text label background
...
def npr(img_path=None, vid_path=None,vid_out = None):
...
npr(vid_path="t1.mp4", vid_out="output.mp4") ### for custom video
# npr(vid_path=0,vid_out="webcam_facemask_result.mp4") #### for webcam

# npr(img_path="./test_images/11.jpeg") ## for image